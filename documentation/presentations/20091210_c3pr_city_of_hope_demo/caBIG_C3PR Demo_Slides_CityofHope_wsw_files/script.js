...
var gDocTable = new Array(
   new hrefList("slide0033.htm", 1, 1),
   ...
   new hrefList("slide0043.htm", 1, 11),
   new hrefList("slide0044.htm", 1, 12),
   new hrefList("slide0045.htm", 1, 13),
   new hrefList("slide0046.htm", 1, 14),
   new hrefList("slide0047.htm", 1, 15),
   new hrefList("slide0048.htm", 1, 16)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "caBIG_C3PR%20Demo_Slides_CityofHope_wsw_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "caBIG_C3PR%20Demo_Slides_CityofHope_wsw_files/error.htm" );
	}
	else {
